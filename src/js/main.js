...
body.onload = () => {
    ...
    document.title = 'La Situación en la España del Siglo XIX - IShortner';
    body.onload = () => {
        gotourl.href = '';
        gotobtn.disabled = true;
        var unlockTimer = setInterval(function(){                
    ...
    document.title = 'Hidraulica y Neumática - IShortner';
    body.onload = () => {
        gotourl.href = '';
        gotobtn.disabled = true;
        var unlockTimer = setInterval(function(){                
